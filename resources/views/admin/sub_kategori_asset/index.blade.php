...
<head>
    ...
    <title>Data Sub Kategori Asset</title>
...
<body>
    ...
    <div class="main-content">
        <h1>Data Sub Kategori Asset</h1>
        <a href="{{ route('admin.sub_kategori_asset.create') }}" class="add-item-link">Tambah Sub Kategori Asset</a>
            ...
            <tbody>
                @foreach($subKategoriAssets as $subKategoriAsset)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.sub_kategori_asset.edit', $subKategoriAsset->id_sub_kategori_asset) }}">Edit</a>
                            <form action="{{ route('admin.sub_kategori_asset.destroy', $subKategoriAsset->id_sub_kategori_asset) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
