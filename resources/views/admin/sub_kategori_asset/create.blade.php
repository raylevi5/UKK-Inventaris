...
<head>
    ...
    <title>Tambah Sub Kategori Asset</title>
...
<body>
    ...
    <div class="form-container">
        <form action="{{ route('admin.sub_kategori_asset.store') }}" method="POST">
            ...
            <input type="text" name="kode_sub_kategori_asset" id="kode_sub_kategori_asset" required><br>

            <label for="sub_kategori_asset">Sub Kategori Asset</label>
            <input type="text" name="sub_kategori_asset" id="sub_kategori_asset" required><br>
