...
<body>
    ...
    <div class="main-content">
        <h1>Data Merk</h1>
        <a href="{{ route('admin.merk.create') }}" class="add-item-link">Tambah Merk</a>
            ...
            <tbody>
                @foreach($merks as $merk)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.merk.edit', $merk->id_merk) }}">Edit</a>
                            <form action="{{ route('admin.merk.destroy', $merk->id_merk) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
