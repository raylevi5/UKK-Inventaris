...
<div class="form-container">
    <form action="{{ route('admin.merk.update', $merk->id_merk) }}" method="POST">
        ...
        <input type="text" name="merk" id="merk" value="{{ old('merk', $merk->merk) }}" required><br>

        <label for="keterangan">Keterangan</label>
        <input type="text" name="keterangan" id="keterangan" value="{{ old('keterangan', $merk->keterangan) }}"><br>
