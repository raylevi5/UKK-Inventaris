...
<head>
    ...
    <title>Data Kategori Asset</title>
...
<body>
    ...
    <div class="main-content">
        <h1>Data Kategori Asset</h1>
        <a href="{{ route('admin.kategori_asset.create') }}" class="add-item-link">Tambah Kategori Asset</a>
            ...
            <tbody>
                @foreach($kategoriAssets as $kategori)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.kategori_asset.edit', $kategori->id_kategori_asset) }}">Edit</a>
