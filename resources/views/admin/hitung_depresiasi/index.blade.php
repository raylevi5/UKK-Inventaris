...
<head>
    ...
    <title>Data Hitung Depresiasi</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <a href="{{ route('admin.hitung_depresiasi.create') }}" class="add-item-link">Tambah Hitung Depresiasi</a>
        ...
        <table>
            ...
            <tbody>
                @foreach ($hitungDepresiasis as $depresiasi)
                    <tr>
                        ...
                        <td>Rp {{ number_format($depresiasi->perhitungan['nilai_penyusutan_per_bulan'], 0, ',', '.') }}</td>
                        <td>Rp {{ number_format($depresiasi->nilai_barang - ($depresiasi->perhitungan['nilai_penyusutan_per_bulan'] * $depresiasi->bulan), 0, ',', '.') }}</td>
                        
                        <td>
                            <a href="{{ route('admin.hitung_depresiasi.edit', $depresiasi->id_hitung_depresiasi) }}">Edit</a>
                            <a href="{{ route('admin.hitung_depresiasi.detail', $depresiasi->id_hitung_depresiasi) }}">Detail</a>
                            <form action="{{ route('admin.hitung_depresiasi.destroy', $depresiasi->id_hitung_depresiasi) }}" 
