...
<body>
    ...
    <div class="main-content">
        <h1>Data Opname</h1>
        <a href="{{ route('admin.opname.create') }}" class="add-item-link">Tambah Opname</a>
        ...
        <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.opname.edit', $opname->id_opname) }}">Edit</a>
                            <form action="{{ route('admin.opname.destroy', $opname->id_opname) }}" 
